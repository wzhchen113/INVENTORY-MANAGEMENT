...
// reorder-export-pdf / reorder-refresh (079 §6 — FROZEN); nav-Ordering (spec
// 138 — Ordering collapsed to the reorder list only; the PO tab was retired, so
// selecting Ordering lands DIRECTLY on the reorder pane — no tab click).
