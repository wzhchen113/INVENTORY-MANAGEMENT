    ...
    if (RESEND_API_KEY) {
      const res = await fetch("https://api.resend.com/emails", {
        ...
        body: JSON.stringify({
          ...
          to: [email],
          subject: "Welcome to I.M.R \u2014 You're all set!",
          html: `<div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;max-width:600px;margin:0 auto;padding:40px 20px"><div style="background:#1A1A18;border-radius:12px;padding:32px;text-align:center;margin-bottom:24px"><h1 style="color:#FFF;font-size:28px;margin:0;letter-spacing:1px">I.M.R</h1><p style="color:rgba(255,255,255,0.7);margin:4px 0 0;font-size:14px">Inventory Management for Restaurant</p></div><div style="text-align:center;margin-bottom:24px"><div style="width:64px;height:64px;background:#EAF3DE;border-radius:50%;display:inline-flex;align-items:center;justify-content:center;font-size:32px">\u2705</div></div><h2 style="color:#1A1A18;font-size:22px;text-align:center">You're all set, ${escapeHtml(name)}!</h2><p style="color:#6B6A65;font-size:15px;line-height:1.6;text-align:center">Congratulations! Your account has been created and you're ready to use I.M.R Inventory Management.</p><p style="color:#6B6A65;font-size:15px;line-height:1.6;text-align:center">You can now sign in with your email and password.</p><div style="text-align:center;margin:32px 0"><a href="${escapeHtml(APP_URL)}" style="background:#1A1A18;color:#FFF;padding:14px 32px;border-radius:8px;text-decoration:none;font-weight:600;font-size:16px;display:inline-block">Sign in now</a></div><hr style="border:none;border-top:1px solid #EEEDE8;margin:32px 0"/><p style="color:#9B9A95;font-size:12px;text-align:center">I.M.R \u2014 Inventory Management for Restaurant</p></div>`,
        }),
      });
