// Spec 061 — staff-eod-submit deprecation.
//
// As of spec 061, the staff app talks to Supabase directly via per-user
// JWT and calls public.staff_submit_eod() RPC over PostgREST. This Edge
// Function — which routed the call through a shared STAFF_SERVICE_TOKEN
...
Deno.serve((req: Request) => {
  ...
  return new Response(
    JSON.stringify({
      error: "staff-eod-submit: deprecated as of spec 061 — staff app now talks to Supabase directly via per-user JWT",
