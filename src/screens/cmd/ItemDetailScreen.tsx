...
// `InventoryDesktopLayout` now serve the Inventory item detail on
// every breakpoint, including phone. Delete in a future cleanup sweep
// once the native-shipping decision is locked.
