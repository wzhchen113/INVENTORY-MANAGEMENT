...
const styles = StyleSheet.create({
  ...
  // instead of overflowing horizontally or pushing the form down.
  logoTitle: { fontSize: 18, fontWeight: '600', color: Colors.textPrimary, textAlign: 'center', flexWrap: 'wrap' },
